...
import 'package:flutter_application_1/sayfalar/profiliduzenle.dart';
          ...
          Row(
            children: <Widget>[
              CircleAvatar(
                ...
                radius: 50.0,
                backgroundImage: profilData.fotoUrl.isNotEmpty ? NetworkImage(profilData.fotoUrl) : AssetImage("assets/images/profilfoto.jpg"),
              ),
              Expanded(
                            child: Row(
