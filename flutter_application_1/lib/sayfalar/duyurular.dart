...
import 'package:flutter_application_1/modeller/duyuru.dart';
import 'package:flutter_application_1/modeller/kullanici.dart';
import 'package:flutter_application_1/sayfalar/profil.dart';
import 'package:flutter_application_1/sayfalar/tekligonderi.dart';
...
class _DuyurularState extends State<Duyurular> {
  ...
  Future<void>duyurulariGetir() async {
    List<Duyuru> duyurular =
        ...
        if (mounted) { //Sayfanın değiştirilmemiş olup olmadığı kontrol edilir
  setState(() {
  ...
  duyurulariGoster(){
    ...
    return Padding(
      ...
      child: RefreshIndicator( //Sayfayı yenilemek için
